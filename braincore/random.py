...
def randint(low, high=None, size: Optional[Size] = None,
  ...
  >>> bc.random.randint(5, size=(2, 4))
  array([[4, 0, 2, 1], # random
         [3, 2, 2, 0]])

  Generate a 1 x 3 array with 3 different upper bounds

  >>> bc.random.randint(1, [3, 5, 10])
  array([2, 2, 9]) # random

  Generate a 1 by 3 array with 3 different lower bounds

  >>> bc.random.randint([1, 5, 7], 10)
  array([9, 8, 7]) # random

  Generate a 2 by 4 array using broadcasting with dtype of uint8

  >>> bc.random.randint([1, 3, 5, 7], [[10], [20]], dtype=np.uint8)
...
def random_integers(low,
  ...
  <class 'numpy.int64'>
  >>> bc.random.random_integers(5, size=(3,2))
  array([[5, 4], # random
         [3, 3],
         [4, 5]])
  ...
  >>> 2.5 * (bc.random.random_integers(5, size=(5,)) - 1) / 4.
  array([ 0.625,  1.25 ,  0.625,  0.625,  2.5  ]) # random

  Roll two six sided dice 1000 times and sum the results:

  >>> d1 = bc.random.random_integers(1, 6, 1000)
  >>> d2 = bc.random.random_integers(1, 6, 1000)
  >>> dsums = d1 + d2
...
def random_sample(size: Optional[Size] = None, key: Optional[SeedOrKey] = None, dtype: DTypeLike = None):
  ...
  <class 'float'>
  >>> bc.random.random_sample((5,))
  array([ 0.30220482,  0.86820401,  0.1654503 ,  0.11659149,  0.54323428]) # random

  Three-by-two array of random numbers from [-5, 0):

  >>> 5 * bc.random.random_sample((3, 2)) - 5
...
def choice(a, size: Optional[Size] = None, replace=True, p=None,
  ...
  >>> bc.random.choice(5, 3, p=[0.1, 0, 0.3, 0.6, 0])
  array([3, 3, 0]) # random

  Generate a uniform random sample from np.arange(5) of size 3 without
  replacement:

  >>> bc.random.choice(5, 3, replace=False)
  array([3,1,0]) # random
  ...
  >>> bc.random.choice(5, 3, replace=False, p=[0.1, 0, 0.3, 0.6, 0])
  array([2, 3, 0]) # random
  ...
  >>> bc.random.choice(aa_milne_arr, 5, p=[0.5, 0.1, 0.1, 0.3])
...
def permutation(x,
  ...
  >>> bc.random.permutation([1, 4, 9, 12, 15])
  array([15,  1,  9,  4, 12]) # random

  >>> arr = np.arange(9).reshape((3, 3))
  >>> bc.random.permutation(arr)
  array([[6, 7, 8], # random
         [0, 1, 2],
         [3, 4, 5]])
  """
