...
class TestIfElse(unittest.TestCase):
  def test1(self):
    def f(a):
      return bc.transform.ifelse(conditions=[a < 0, a < 2, a < 5, a < 10],
                                 branches=[lambda: 1,
                                           lambda: 2,
                                           lambda: 3,
                                           lambda: 4,
  ...
  def test_vmap(self):
    def f(operands):
      f = lambda a: bc.transform.ifelse(conditions=[a > 10, a > 5, a > 2, a > 0],
                                        branches=[lambda _: 1,
                                                  lambda _: 2,
                                                  lambda _: 3,
                                                  lambda _: 4,
  ...
  def test_grad1(self):
    def F2(x):
      return bc.transform.ifelse(conditions=(x >= 10,),
                                 branches=[lambda x: x,
                                           lambda x: x ** 2, ],
                                 operands=x)
  ...
  def test_grad2(self):
    def F3(x):
      return bc.transform.ifelse(conditions=(x >= 10, x >= 0),
                                 branches=[lambda x: x,
                                           lambda x: x ** 2,
                                           lambda x: x ** 4, ],
                                 operands=x)
